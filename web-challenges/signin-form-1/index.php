		...
		<div class="container-xl">
			...
			?>
				<div class="alert alert-success">
					Success! You found the login credentials. Flag: <code>take-opsec-classes</code>
				</div>
			<?php
				// Default
				} else {
			?>
				<div class="alert">
					See if you can find the username and password for the signin form below
				</div>
			<?php
			...
			<div class="row">
				<form action="/" method="POST">
					...
					<button type="submti" class="btn btn-primary">Sign in</button>
				</form>
			</div>
		</div>
	</body>
